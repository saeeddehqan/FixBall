...
$direct = str_replace("/record_result.php", "", $_SERVER['REQUEST_URI']);
...
<body>
	...
	<div class="page-top-area set-bg" data-setbg="img/record_result.jpg">
		<div class="breadcrumb-area">
			<a href="#">ثبت نتیجه بازی</a> / <a href="index.php">خانه</a>
		</div>
	</div>
							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
									<?php 
										...
										if(!empty($_POST["submit1"]) and !empty($_POST["t1"]) and !empty($_POST["t2"]) and !empty($_POST["date"]) and !empty($_POST["week"]) and !empty($_POST["tg1"]) and !empty($_POST["tg2"]) and !empty($_POST["referee"])){
											$p = $_POST;
											if(!(int)$p["tg1"] or !(int)$p["tg2"] or !(int)$p["week"]){
											...
											elseif(!is_date($_POST["date"])){
												...
												$sql = "INSERT INTO `games` (`id`, `first_team`, `second_team`, `date`, `first_team_goal`, `second_team_goal`, `week`, `referee`) VALUES (NULL,?,?,?,?,?,?,?)";
												$sabt = pdoConnect($sql, array($p['t1'], $p["t2"], $p["date"], $p['tg1'], $p['tg2'], $p["week"], $p["referee"]));
